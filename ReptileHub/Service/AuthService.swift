...
final class AuthService: AuthServiceProtocol {
    ...
    private let kakaoAuthManager: KaKaoAuthManagerProtocol
    private let googleAuthManager: GoogleAuthManagerProtocol
    private let appleAuthManager: AppleAuthManagerProtocol
    
    init(kakaoAuthManager: KaKaoAuthManagerProtocol, 
         googleAuthManager: GoogleAuthManagerProtocol,
         appleAuthManager: AppleAuthManagerProtocol
    ) {
    ...
    func loginWithApple(presentingViewController: UIViewController) -> AnyPublisher<Bool, any Error> {
        return appleAuthManager.login(presentingViewController: presentingViewController)
    }
}
